...
class _OpinionState extends State<Opinion> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      GetBuilder<SitioController>(builder: (sitio) {
                        return Expanded(
                          child: SizedBox(
                              height: 44.4,
                              child: CustomElevatedButton(
                                  ...
                                  onPressed: hasText
                                      ? _publicarComentario
                                      : () {
                                          GetxUtils().messageError(
                                              'Notificación',
                                              'Por favor!, Agrega una opinión primero');
                                        },
                                  text: 'Publicar')),
                        );
                      })
  ...
  Future<void> _publicarComentario() async {
    final SitioRepository sitioRepository = SitioRepositoryImp();
    final SitioController sitio = SitioController(sitioRepository);
    Map punutacion = {
